...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataBase.Device_model", b =>
                {
                    b.Property<int>("keyModel")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataBase.Customer_device", b =>
                {
                    ...
                    b.HasOne("DataBase.Device_model", "deviceModel")
                        .WithMany("devices")
                        .HasForeignKey("keyModel")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataBase.Device_model", b =>
                {
                    b.HasOne("DataBase.Device_type", "deviceType")
                        .WithMany("devices")
