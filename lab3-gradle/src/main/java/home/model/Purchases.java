...
//    private int days_guarantee;
    ...
    public Purchases(String name, Double purchase_price, Double retail_price, Integer amount, Integer days_guarantee, Integer id_part_type){
        this.purchase_price = purchase_price;
        this.retail_price = retail_price;
        this.amount = amount;
//        this.days_guarantee = days_guarantee;
        this.name = name;
